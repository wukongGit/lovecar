 ...
 */
class ViolationCitySelectAdapter(private val mList: List<ApiViolationModel.ApiViolationCity>): BaseBindingAdapter<ItemCityBinding>() {
    ...
    override fun onBindViewHolder(holder: DataBoundViewHolder<ItemCityBinding>, position: Int) {
        ...
        holder.binding.item = mList[position].city
